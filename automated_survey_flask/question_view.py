...
VOICE_INSTRUCTIONS = {
        ...
        Question.BOOLEAN: 'Is there a medical emergency happening now? Press 1 for yes, 0 for no.',
        Question.NUMERIC: 'Please key in your ZIP code.'
        Question.TEXT: 'What supplies do you need?'
}
